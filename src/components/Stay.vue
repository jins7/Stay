      ...
      <div class="container">
        <div class="row justify-content-center align-items-center py-5">
          ...
          <div class="col-12">
            ...
            <div class="h6 fw-light text-center mb-5">UI界面编辑器（开发端）</div>
          </div>
          ...
          <div class="d-flex align-items-center">
            <img src="../assets/icon/idea1.png" width="30" height="30" class="m-2" alt="">
            <div class="my-2 h6 fw-light">仅需简单的添加节点与连线便可以构建计算器等小应用，棋类等小游戏</div>
          </div>

          <div class="d-flex my-3">
            <img class="col-12 rounded-3" src="../assets/image/stay/product2.gif" alt="GIF Image">
          </div>
          <div class="col-12 h6 fw-light text-center mb-5">无代码编辑器（开发端）</div>
        </div>
      </div>
    </div>
  </section>
